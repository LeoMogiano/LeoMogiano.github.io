...
const JOBS = [
  ...
  // Capturas de app — la pantalla del teléfono mide ~282 px CSS, así que 564
  // es 2x exacto. La extensión va por captura: las dos últimas de EGX Staff son
  // fotos del escáner, y llegaron en JPEG.
  ...[
